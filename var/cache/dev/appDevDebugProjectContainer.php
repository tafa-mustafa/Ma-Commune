...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_5dc40bf048b6de342ebc61b900060a1fc28023300799411d4d172e9f10cf1f6c' => 'get15dc40bf048b6de342ebc61b900060a1fc28023300799411d4d172e9f10cf1f6cService',
            '2_5dc40bf048b6de342ebc61b900060a1fc28023300799411d4d172e9f10cf1f6c' => 'get25dc40bf048b6de342ebc61b900060a1fc28023300799411d4d172e9f10cf1f6cService',
        ...
        $this->privates = array(
            '1_5dc40bf048b6de342ebc61b900060a1fc28023300799411d4d172e9f10cf1f6c' => true,
            '2_5dc40bf048b6de342ebc61b900060a1fc28023300799411d4d172e9f10cf1f6c' => true,
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_5dc40bf048b6de342ebc61b900060a1fc28023300799411d4d172e9f10cf1f6c']) ? $this->services['1_5dc40bf048b6de342ebc61b900060a1fc28023300799411d4d172e9f10cf1f6c'] : $this->get15dc40bf048b6de342ebc61b900060a1fc28023300799411d4d172e9f10cf1f6cService()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_5dc40bf048b6de342ebc61b900060a1fc28023300799411d4d172e9f10cf1f6c']) ? $this->services['2_5dc40bf048b6de342ebc61b900060a1fc28023300799411d4d172e9f10cf1f6c'] : $this->get25dc40bf048b6de342ebc61b900060a1fc28023300799411d4d172e9f10cf1f6cService()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'Bibliotheque', 'user' => 'root', 'password' => 'tafatene10', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'/src/AppBundle/Resources/config/doctrine') => 'AppBundle\\Entity', ($this->targetDirs[3].'/src/MBC/bibliocommuneBundle/Resources/config/doctrine') => 'MBC\\bibliocommuneBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'AppBundle\\Entity');
        $b->addDriver($a, 'MBC\\bibliocommuneBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('AppBundle' => 'AppBundle\\Entity', 'bibliocommuneBundle' => 'MBC\\bibliocommuneBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_990c5256812ec8fe6bf532464a56c20278668d92a90c2ea51743c034c17ad9f2');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/MBC/bibliocommuneBundle/Resources/views'), 'bibliocommune');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('a5ae26abeb4e3d2848f7e60dbd4a6e88302e4347');
    }
    ...
    /**
     * Gets the private '1_5dc40bf048b6de342ebc61b900060a1fc28023300799411d4d172e9f10cf1f6c' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker
     */
    protected function get15dc40bf048b6de342ebc61b900060a1fc28023300799411d4d172e9f10cf1f6cService()
    {
        return $this->services['1_5dc40bf048b6de342ebc61b900060a1fc28023300799411d4d172e9f10cf1f6c'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the private '2_5dc40bf048b6de342ebc61b900060a1fc28023300799411d4d172e9f10cf1f6c' shared service.
     *
     * @return \Symfony\Component\Config\Resource\SelfCheckingResourceChecker
     */
    protected function get25dc40bf048b6de342ebc61b900060a1fc28023300799411d4d172e9f10cf1f6cService()
    {
        return $this->services['2_5dc40bf048b6de342ebc61b900060a1fc28023300799411d4d172e9f10cf1f6c'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Zo3345-GJD', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0z4blqHCbU', 0, 'LH2l-tN36ufcoOd8dyqJzn', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kv9igKtQcY', 0, 'LH2l-tN36ufcoOd8dyqJzn', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('P9lTR6Ou6v', 0, 'LH2l-tN36ufcoOd8dyqJzn', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5ac1287ad12227.50501637');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'bibliocommuneBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/MBC/bibliocommuneBundle'),
                    'namespace' => 'MBC\\bibliocommuneBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'bibliocommuneBundle' => 'MBC\\bibliocommuneBundle\\bibliocommuneBundle',
            ...
            'secret' => 'a5ae26abeb4e3d2848f7e60dbd4a6e88302e4347',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'a5ae26abeb4e3d2848f7e60dbd4a6e88302e4347',
